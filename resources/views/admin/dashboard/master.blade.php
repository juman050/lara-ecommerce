...
<head>
  ...
  <link rel="stylesheet" href="{{asset('public/backEnd/dist/css/skins/skin-blue.min.css')}}">
    ...
    <script src="{{asset('public/backEnd/plugins/tinymce/js/tinymce/tinymce.min.js')}}"></script>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; {{date('y')}} <a href="https://www.facebook.com/juman1971">Juman</a>.</strong> All rights reserved.
  </footer>
