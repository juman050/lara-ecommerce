        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              <p>
                  <?php
                     $adminInfo = DB::table('admin')->where('admin_id',Session::get('admin_id'))->first();
                     ?>
                {{$adminInfo->admin_name}} - Web Developer
                <small>Member since - {{ date('F j, Y',strtotime($adminInfo->created_at)) }}</small>
              </p>
            </li>
            <!-- Menu Body 
            <li class="user-body">
