...
<hr/>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::open(['url' => '/update-manufacturer','name'=>'updateManufacturer','method' => 'POST','enctype' =>'multipart/form-data']) !!}
    
      <div class="box-body">
        <div class="form-group">
            <label for="exampleInputEmail1" class="control-label">Manufacturer Name</label>
          <input type="text" name="manufacturerName" class="form-control" id="exampleInputEmail1" value="{{ $manufacturerInfo->manufacturerName }}">
          <span class="text-danger">{{ $errors->has('manufacturerName') ? $errors->first('manufacturerName') : '' }}</span>
          <input type="hidden" name="manufacturerId" value="{{ $manufacturerInfo->id }}">
        </div>
        <div class="form-group">
          ...
          {{ $manufacturerInfo->manufacturerDescription }}
          </textarea>
        ...
        <div class="form-group">
            ...
            <img width="70px" height="50px" src="{{asset($manufacturerInfo->manufacturerImage)}}">
...
<script type="text/javascript">
    document.forms['updateManufacturer'].elements['publicationStatus'].value='<?php echo $manufacturerInfo->publicationStatus;?>'
</script>
@endsection
